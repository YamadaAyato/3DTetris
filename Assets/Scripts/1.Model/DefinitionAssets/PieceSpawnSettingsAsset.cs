...
namespace ThreeDTetris.Model
{
    ...
    public class PieceSpawnSettingsAsset : ScriptableObject
    {
        ...
        {
            return new PieceSpawnSettings(_originX, _spawnHeightOffset, _initialRotation);
        }

        [SerializeField] private int _originX = 0;
        [SerializeField] private int _spawnHeightOffset = 0;
        [SerializeField] private PieceRotation _initialRotation = PieceRotation.Rotation0;
    }
}
