...
namespace ThreeDTetris.Usecase
{
    ...
    /// </summary>
    public class PieceFaceSwitchUsecase
    {
        public PieceFaceSwitchUsecase(IBoardTopology boardTopology, PiecePlacementValidator placementValidator)
        {
        ...
        public bool TrySwitchFace(ActivePiece activePiece, BoardFaceId targetFaceId)
        {
            ...
            int maxUpOffset = _boardTopology.GetFaceHeight(targetFaceId) + 4;
